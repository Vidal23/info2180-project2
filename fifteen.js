...
let images = [
    {name: 'Default', url: './background.jpg'},
    {name: 'Bowser Koopa', url: 'http://static.gcstudio.org/fifteen_puzzle/bowser-koopa.jpg'},
    {name: 'Bowser JR', url: 'http://static.gcstudio.org/fifteen_puzzle/bowser_jr.jpg'},
    {name: 'Mario Yoshi', url: 'http://static.gcstudio.org/fifteen_puzzle/mario_yoshi.jpg'},
    {name: 'Princess Peach', url: 'http://static.gcstudio.org/fifteen_puzzle/princess_peach.jpg'},
    {name: 'Lakitu', url: 'http://static.gcstudio.org/fifteen_puzzle/lakitu.jpg'},
    {name: 'Goomba', url: 'http://static.gcstudio.org/fifteen_puzzle/goomba.jpg'}
];
